      ...
      <section className="section-pad py-16 lg:py-24">
        <div className="container-wide grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card className="p-8 lg:p-10 border-l-4 border-l-flame-500">
            ...
            <p className="text-muted-foreground leading-relaxed">To become a pillar of success and unparalleled authority by: Reaching a minimum of 100,000 potential clients daily, Ensuring customer satisfaction, Operating with the highest standards of corporate governance, Minimising property-related risks, Becoming a globally recognized Real Estate brand.
